...
export function Sidebar() {
  ...
  return (
<div className="  absolute z-10 bg-white bottom-0 w-full md:fixed h-[48px] flex md:flex-col flex-row  xl:max-w-[250px] md:max-w-[96px] md:h-screen md:border-black-400 md:border-r-2">
    <div className="flex md:flex-col flex-row md:py-4 h-full xl:max-w-[250px] md:max-w-[96px]" >
        <div className="md:px-3   md:py-2 flex md:flex-col flex-row  justify-between h-full max-md:w-full">
            ...
            <div className="md:space-y-1 md:flex md:flex-col flex-row md:w-full w-screen  grid grid-cols-5 grid-rows-1 md:justify-center">
                <Button onClick={()=>setSide('home')} variant="secondary" className="h-full md:h-[50px]   justify-center md:justify-start gap-5 ">
                ...
                <Sheet>
                  ...
                  <SheetContent>
                    ...
                    <Dialog>
                      <DialogTrigger>
                        <Button onClick={()=>setSide('create')} variant="ghost" className="w-full h-full md:h-[50px] justify-center md:justify-start gap-5">
                ...
                <Button variant="ghost" className=" h-[50px] justify-center md:justify-start gap-5">
