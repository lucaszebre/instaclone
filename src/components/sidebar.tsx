...
export function Sidebar() {
  ...
  return (
<div className="  absolute  bottom-0 w-full md:fixed h-[48px] flex md:flex-col flex-row  xl:max-w-[250px] md:max-w-[96px] md:h-screen md:border-black-400 md:border-r-2">
    <div className="flex md:flex-col flex-row py-4 h-full xl:max-w-[250px] md:max-w-[96px]" >
        <div className="px-3  py-2 flex md:flex-col flex-row  justify-between h-full max-md:w-full">
            <div  className="mb-[20px] xl:flex hidden">
            ...
            <div className="mb-[20px]  md:flex justify-center hidden  xl:hidden">
            ...
            <div className="space-y-1 flex md:flex-col flex-row md:w-full w-screen justify-center">
                <Button onClick={()=>setSide('home')} variant="secondary" className="h-[50px] w-full  justify-center md:justify-start gap-5 ">
                ...
                <Sheet>
  <SheetTrigger>
                <Button onClick={()=>setSide('search')} variant="ghost" className="h-[50px] w-full justify-center md:justify-start gap-5">
                ...
                <p className="xl:flex  hidden">Search</p>
                </Button>
                </SheetTrigger>
  <SheetContent>
    <SheetHeader>
...
<Dialog>
  <DialogTrigger>
    <Button onClick={()=>setSide('create')} variant="ghost" className="w-full h-[50px] justify-center md:justify-start gap-5">
              ...
              <p className="xl:flex  hidden">Create</p>
                </Button>
                </DialogTrigger>
  <DialogContent className="flex flex-col justify-center items-center content-center text-center">
    ...
    <Button>Select from computer</Button>
        ...
        <Button onClick={()=> setSide('messages')} variant="ghost" className="h-[50px] w-full justify-center md:justify-start gap-5">
                ...
                <p className="xl:flex  hidden">Messages</p>
                </Button>

              
                
                <Button  variant="ghost" className="w-full  justify-center md:justify-start gap-5 md:flex hidden  xl:hidden">
                {}
                <p className="xl:flex  hidden">Notiffication</p>
                </Button>
                
                <Button variant="ghost" className="w-full h-[50px] justify-center md:justify-start gap-5">
                <Avatar className="hover:w-[26px] hover:h-[26px] w-[24px] h-[24px]" >
                    <AvatarImage src="https://github.com/shadcn.png" />
                    <AvatarFallback>CN</AvatarFallback>
                </Avatar>
                <p className="xl:flex  hidden">Profil</p>
                </Button>
                </div>
            ...
            <DropdownMenu >
                <DropdownMenuTrigger className="w-full">
                    <Button onClick={()=> setSide('plus')} variant="ghost" className="w-full h-[50px] justify-start gap-5">
                                ...
                                <p className="xl:flex  hidden">Plus</p>
                                </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent className="ml-2 w-[250px]">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={()=>signOut()}><Button variant="ghost" className="w-full justify-start gap-5" >Déconnexion</Button></DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
