...
export function Sidebar() {
  ...
  return (
<div className="  absolute   bottom-0 w-full md:relative h-[48px] flex md:flex-col flex-row  xl:max-w-[250px] md:max-w-[96px] md:h-screen border-black-400 border-r-2">
