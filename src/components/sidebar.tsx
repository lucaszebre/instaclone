...
<div className={`  ${short  && 'md:w-[96px]' || ' xl:max-w-[250px] md:max-w-[96px] w-full'} bg-white dark:bg-black  transition-width duration-500   absolute z-20 bottom-0  md:fixed h-[48px] flex md:flex-col flex-row   md:h-screen md:border-black-400 md:border-r-2`}>
    <div className={` ${short && 'md:w-[96px]' || ' xl:max-w-[250px] md:max-w-[96px] w-full'}  flex md:flex-col flex-row md:py-4 h-full `} >
        <div className="md:px-3   md:py-2 flex md:flex-col flex-row  justify-between h-full max-md:w-full">
            
            <div  className={`${short?'hidden':'xl:flex hidden'} mb-[20px] `}>
            ...
            <div className="md:space-y-1 content-start   md:flex md:flex-col flex-row md:w-full w-screen items-center z-10  grid grid-cols-5 grid-rows-1 md:justify-center">
                ...
                <Button asChild  variant="ghost" className="h-full md:h-[50px] md:w-full  justify-center md:justify-start gap-5 ">
                    <Link href={'/'} onClick={()=>{setShort(false)}}>
                      ...
                      <p className={`${pathname==='/'  ?'font-bold':''} ${short? 'hidden' : 'xl:flex  hidden'} `}>Home</p>
                    </Link>
                </Button>
                ...
                <Search>
                  <Button onClick={() => handleSidebarToggle('search')} variant="ghost" className=" w-full h-full md:h-[50px]  justify-center md:justify-start gap-5">
                    ...
                    <p className={`${search?'font-bold':''} ${short &&  'hidden' || 'xl:flex  hidden'} `}>Search</p>
                  </Button>
                </Search>
                ...
                <AddFile>
                  <Button   variant="ghost" className="w-full  h-full md:h-[50px] justify-center md:justify-start gap-5">
                    ...
                    <p className={` ${short? 'hidden' : 'xl:flex  hidden'}`}>Create</p> 
                  </Button>
                </AddFile>
                ...
                <Button onClick={() => handleSidebarToggle('notifications')}   variant="ghost" className="h-full w-full hidden md:flex  justify-center md:justify-start gap-5   xl:hidden">
                ...
                <Button asChild  onClick={()=>{setShort(false)}}  variant="ghost" className="md:w-full h-full md:h-[50px] justify-center md:justify-start gap-5">
                  <Link href={`/${data?.username}`}>
                    ...
                    <p className={`${pathname===`/${data?.username}`?'font-bold':''} ${short?'hidden' : 'xl:flex  hidden'}`}>Profil</p> 
                  </Link>
                </Button>
                </div>
            ...
            <div className="md:flex hidden">
                <Plus>
                  <Button onClick={() => handleSidebarToggle('plus')} variant="ghost" className="w-full h-full md:h-[50px] justify-start gap-5">
                      ...
                      <p className={`${side=='plus'?'font-bold':''} ${short?'hidden' : 'xl:flex  hidden'}`}>More</p>
                  </Button>
                </Plus>
