...
const MenuMobile = (props:{profile?:boolean,username?:string}) => {
  ...
  if(props.profile){
    return (
      <div className='md:hidden px-2 z-10 content-center w-full items-center absolute top-0 h-[40px] flex flex-row justify-center bg-white dark:bg-black'>
          <span>{props.username}</span>
      </div>
    )
  }else{
    return (
      <div className='md:hidden px-2 z-10 p-2 content-center w-full absolute top-0 h-[40px] flex flex-row justify-between bg-white dark:bg-black'>
          ...
          <div className='flex flex-row p-2 items-center justify-between gap-2'>
            <Search>
              <Input className='bg-muted h-[30px] w-full' placeholder='Search'/>
            </Search>
